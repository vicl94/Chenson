<html>
	<title>Tlaxcala |Mochilas Chenson</title>
    <link rel="shortcut icon" type="image/x-icon" href="/../img/icons/chenson.ico">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<meta name="description" content="Distribuidores de mochilas y accesorios para viaje en Tlaxcala" />
    <link rel="shortcut icon" type="image/x-icon" href="/../img/icons/chenson.ico">
</html>
...
?>
      ...
      <?php
	    $query="select * from ctes_map where Estado='Tlaxcala' ";
