<html>
	<title>Aguascalientes |Mochilas Chenson</title>
    <link rel="shortcut icon" type="image/x-icon" href="/../img/icons/chenson.ico">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name=”robots” CONTENT=”NOODP”>
	<meta name="description" content="Distribuidores de mochilas y accesorios para viaje en Aguascalientes" />
    <link rel="shortcut icon" type="image/x-icon" href="/../img/icons/chenson.ico">
</html>
...
?>
      ...
      <?php
	    $query="select * from ctes_map where Estado='Aguascalientes' ";
	...
	echo "No se han encontrado registros para mostrar";
		...
		<?php
			...
			?>	
            <div class= "titulosCte"><?php echo $Estado?></div>	
        </div>
