                        ...
                        <div class="contlight">	
                            <div onClick="displayHideBox('1'); return false;" style="cursor:pointer;" align="right">
                             ...
                             <br>
                                ...
                                <br>
                                <p align="center">Para compras o mayor información, ponemos a tu disposición los siguientes medios:</p>
                                <br>
...
<a href="#" onClick="displayHideBox('1'); return false;"><img src="../img/icons/comprarON.png" width="100%"></a>
        ...
        <div id="Miniaturas">
              ...
              <tr>
                ...
                <td><img src="<?php echo $Lat;?>" width="100%"  name="lateral"  OnMouseOver="preview.src=lateral.src"  /></td>
                ...
                <td><img src="<?php echo $Det;?>" width="100%" name="Detalle"  OnMouseOver="preview.src=Detalle.src"  /></td>
                <td><img src="<?php echo $Sup;?>" width="100%" name="Referencia"  OnMouseOver="preview.src=Referencia.src"  /></td>
              </tr>
        	</table>
        </div>
        <br /><br /><br /><br /><br />
    ...
    <div id="horizontalTab">
        ...
        <div id="tab-1">
            ...
            <br />
            Capacidad en litros:  <?php echo $Litros ?>
            <br /><br />
            Materiales:
            <br />
            Exterior: <?php echo $MatExt ?>
            <br />
            Forro interno: <?php echo $Forro ?>
