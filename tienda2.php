...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Productos |Mochilas Chenson</title>
        <meta name="robots" content="INDEX,FOLLOW" />
        <meta name="description" content="Tenemos para ti una amplia variedad de mochilas, maletas, portafolios, loncheras y más… " />
    ...
    <body>
    	<div id="cuerpoborrar">
            ...
            <br /><br />
		<center>
        <a href="galerias/1818.php">
            <div class="Licencia1">
            	<img src="img/licencias/Licencias/1818.jpg" width="95%" />
                <br />
                <p class="TituloLic">1818</p>
            </div>
         </a>
         <a href="galerias/carry.php">  	
            <div class="Licencia5">
            	<img src="img/licencias/Licencias/Carry.jpg" width="95%" />
                <br />
                <p class="TituloLic">Carry</p>
            </div>
          </a>
          <a href="galerias/changolos.php">  
            <div class="Licencia3">
            	<img src="img/licencias/Licencias/Changolos.jpg" width="95%" />
                <br />
                <p class="TituloLic">Changolos</p>
            </div>
          </a>
          <a href="galerias/chenson_original.php">  
            <div class="Licencia4">
            	<img src="img/licencias/Licencias/Chenson.jpg" width="95%" />
                <br />
                <p class="TituloLic">Chenson</p>
            </div>
          </a>
          <a href="galerias/chenson_original.php">  
            <div class="Licencia2">
            	<img src="img/licencias/Licencias/Chenson-Original.jpg" width="95%" />
                <br />
                <p class="TituloLic">Chenson Original</p>
            </div>
          </a>
          <a href="galerias/fulanitos.php">  
            <div class="Licencia4">
            	<img src="img/licencias/Licencias/Fulanitos.jpg" width="95%" />
                <br />
                <p class="TituloLic">Fulanitos</p>
            </div>
          </a>
          <a href="galerias/gusanito.php">  
            <div class="Licencia1">
            	<img src="img/licencias/Licencias/Gusanito.jpg" width="95%" />
                <br />
                <p class="TituloLic">Gusanito</p>
            </div>
          </a>
          <a href="galerias/happy-girl.php">  
       		<div class="Licencia3">
            	<img src="img/licencias/Licencias/Happy-Girl.jpg" width="95%" />
                <br />
                <p class="TituloLic">Happy Girl</p>
            </div>
          </a>
          <a href="galerias/mafalda.php">
            <div class="Licencia2">
            	<img src="img/licencias/Licencias/Mafalda.jpg" width="95%" />
                <br />
                <p class="TituloLic">Mafalda</p>
            </div>
           </a>
           <a href="galerias/MarioBros.php"> 
            <div class="Licencia3">
            	<img src="img/licencias/Licencias/Mario-Bros.jpg" width="95%" />
                <br />
                <p class="TituloLic">Mario Bros</p>
            </div>
        </a>
        <a href="galerias/nici.php"> 
            <div class="Licencia6">
            	<img src="img/licencias/Licencias/Nici.jpg" width="95%" />
                <br />
                <p class="TituloLic">Nici</p>
            </div>
        </a> 
        <a href="galerias/pink panther.php">
            <div class="Licencia2">
            	<img src="img/licencias/Licencias/Pantera-Rosa.jpg" width="95%" />
                <br />
                <p class="TituloLic">Pink Panther</p>
            </div>
        </a>
        <A href="galerias/sandichos.php">    
            <div class="Licencia4">
            	<img src="img/licencias/Licencias/Sandichos.jpg" width="95%" />
                <br />
                <p class="TituloLic">Sandichos</p>
            </div>
        </A>
        <a href="galerias/snoopy.php">    
            <div class="Licencia3">
            	<img src="img/licencias/Licencias/Snoopy.jpg" width="95%" />
                <br />
                <p class="TituloLic">Snoopy</p>
            </div>
        </a>
        <a href="galerias/yosha.php">    
             <div class="Licencia1">
            	<img src="img/licencias/Licencias/Yosha.jpg" width="95%" />
                <br />
                <p class="TituloLic">Yosha</p>
            </div>
        </a>
        <a href="Ferlo.php">    
            <div class="Licencia5">
            	<img src="img/licencias/marcas/1818_color2.png" width="95%" />
                <br />
                <p class="TituloLic"></p>
            </div>
        </a>    
        ...
        <br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />
            ...
            <table border="0" cellpadding="0" class="TablaPie">
              <tr>
                <td width="8%" class="Hpie">Nosotros</td>
          ...
          <table class="TablaPie2" border="0">
              ...
              <tr>
                <td width="33%"><img src="img/icons/Facebook.png" width="40%"></td>
                <td width="33%"><img src="img/icons/twitter.png" alt="" width="40%" /></td>
                <td width="33%"><img src="img/icons/youtube3.png" alt="" width="40%" /></td>
              </tr>
              <tr>
