...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  (function() {
    ...
    <body>
        ...
        <div class= "titulos3">Bienvenidos al mundo</div>
				<div class="sub5">CHENSON</div>
                <center>
               <div class="jimgMenu">
  <ul>
    <li id="landscapes"><a href="http://www.chenson.com.mx/donde_comprar.php">Educación</a></li>
    <li id="people"><a href="http://www.chenson.com.mx/tienda.php">Salud</a></li>
    <li id="nature"><a href="">Familia</a></li>
    <li id="abstract"><a href="">Moda</a></li>
    <li id="urban"><a href="">Diversión</a></li>
  </ul>
</div>
<br  style="clear:both"/>
...
<hr style="width:100%;text-align:center;height:2px;border:1px;color:#e2e2e2;background-color:#e2e2e2;" />
                ...
                <br />
                <center>
                <div class="sub5">Post recientes</div>
                <div class="recientes">
                <h3 align="center">Fiestas de octubre 2013</h3>
                
                <br />
                <img src="../boletin/portada-fiestas-de-octubre.png" width="250px" />
                <br /> 
                <br />
                
                
                Las fiestas de octubre nacen en la ciudad de Guadalajara en el año de 1965, 
                convirtiéndose a la fecha en toda una tradición y una de las expresiones culturales 
                más importantes del estado. Se trata de un festival recreativo y cultural...
                               
               <a href="http://www.chenson.com.mx/blog/fiestas-de-octubre-2013.php" class="clase2" title="Ver artículo completo"> <p align="right">Ver más</p></a>
                </div>
                <div class="recientes">
                <h3 align="center">Día internacional contra el cancer de mama</h3>
                  <br />
                  <center>
                  <img src="../boletin/liston.png" width="35px" />
                  <br />
                  <br />
                  El cáncer de mama es el tumor más frecuente entre las mujeres occidentales,
                  En la actualidad este padecimiento afecta a 230,000 mujeres tan solo en América....
                  <br />
                 	<br />
                  <br />
                 	<br />  
                  <a href="http://www.chenson.com.mx/blog/Dia-mundial-contra-el-cancer-de-mama.php" class="clase2" title="Ver artículo completo"> <p align="right">Ver más</p></a>
