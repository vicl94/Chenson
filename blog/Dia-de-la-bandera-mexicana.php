...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
     ...
     <title>Día de la bandera mexicana</title>
    ...
    <meta property="og:title" content="Día de la bandera mexicana"/>
    <meta property="og:image" content="http://www.chenson.com.mx/blog/imagenes/bandera-de-mexico.jpg"/>
    <meta property="og:site_name" content="Francisco Salas"/>
    <meta property="og:description" content="El 24 de febrero celebramos a nuestro lábaro patrio, conoce un poco de su historia..." />
...
<!--plug in facebook-->
  ...
  <br /><br /><br />    <br />       
        ...
        <div id="textos2">
        <div class= "titulosTips">Día de la bandera mexicana</div>
         <br /><br /><br /><br />
        <img src="imagenes/bandera-de-mexico.jpg" align="center" width="20%"/>
        <div class="textosIntro">
       El día de hoy conmemoramos orgullosamente a nuestro lábaro patrio, símbolo de nuestra independencia, libertad y derechos como mexicanos, además de representar a nuestra nación ante el mundo entero.
       </div>
        
        <br />  <br />
        
		<div class="sub30">Estandarte del padre Hidalgo</div>
        <br />
        <img src="imagenes/Miguel-Hidalgo.jpg" align="center" width="20%"/>
        <div class="textosIntro">
		Se considera como nuestra primer bandera el estandarte portado por Miguel Hidalgo durante el grito de Dolores, en el cual aparece la virgen de Guadalupe, es considerado como el primer símbolo de la unidad entre los mexicanos, durante el movimiento de independencia.
        </div>
        
          <br />  <br />
          <div class="sub30">Bandera de Morelos</div>
        <br />
        <img src="imagenes/Morelos.jpg" align="center" width="20%"/>
        <div class="textosIntro">
		Pocos años después (en el año de 1913) el ejercito insurgente utilizo un lábaro patrio distinto, en que se mostraba  la leyenda en latín latín Oculis et unguibus aeque victrix (Con los ojos y las uñas, igualmente victoriosa).
        </div>
         <br /><br />
         <div class="sub30">Bandera del Ejército Trigarante</div>
        <br />
        <img src="imagenes/bandera-trigarante.jpg" align="center" width="20%"/>
        <div class="textosIntro">
		La primer bandera que llevo los colores verde blanco y rojo se realizo tras la formulación del plan de Iguala en marzo de 1821, pero el significado no era el mismo que el actual, el color verde representaba la independencia, el blanco la religión y el rojo la unión.
        </div>
          <br /><br />
          <div class="sub30">Bandera del Primer Imperio</div>
        <br />
        <img src="imagenes/primer-imperio.jpg" align="center" width="20%"/>
        <div class="textosIntro">
		Durante su imperio, Agustin de Iturbide dispuso que se utilizaran los mismos colores pero  en posición vertical, en dicha bandera se mostraba al centro el águila de frente con las alas extendidas y una corona en la cabeza, parada en un nopal nacido en el islote de una laguna que simbolizaba el imperio.
        </div>
          <br /><br />
          <div class="sub30">Bandera actual</div>
        <br />
		Fue hasta 1968 mediante un decreto del presidente Gustavo Díaz Ordaz que la bandera nacional fue modificada tal como la conocemos en la actualidad. 
          <br /><br />
          <div class="sub30">Los simbolos:</div>
        <br />
		...
		Nopal: Paisaje de México.
          ...
          <br /><br />
          <div class="sub30">Sus colores:</div>
        <br />
		Verde: Esperanza.
        <br />
		Blanco: Unidad.
       ...
       Fuente: <a href="http://www.sep.gob.mx/es/sep1/24_de_febrero#.VOyPSvmG8-N">SEP</a>  
