...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
     ...
     <title>Alimentos que te harán más feliz</title>
    ...
    <meta property="og:title" content="Alimentos que te harán más feliz|Mochilas Chenson"/>
    ...
    <meta property="og:description" content="En el día internacional de la felicidad, traemos para ti algunos alimentos que te ayudarán a ser aún más feliz de manera natural :)" />
...
<!--plug in facebook-->
  ...
  <br /><br /><br />    <br />       
        ...
        <div class= "titulos2">Tips para iniciar bien la semana</div>
                <center>
        ...
        <br />
       Después de dos reconfortantes días de descanso, el Lunes se ha convertido históricamente en el día más odiado de la semana, el problema es que iniciar mal con el lunes nos puede llevar a tener un mal martes y un peor miércoles, por lo que es importante iniciar la semana con una actitud positiva, levantarte con un ánimo distinto y tratar de disfrutar de tu día, a fin de cuentas que el lunes solo es un día más ¿no? 
        
        <br />  <br />
		<div class="sub">Plátano</div>
        <br />
		Aparte de su alto contenido de nutrientes y fibras, vitaminas y minerales, aporta una gran cantidad de triptófano, aminoácido que nos ayuda tener un sueño saludable y un estado de ánimo agradable funcionando incluso como un antidepresivo natural.
          <br />  <br />
          <div class="sub">Avena</div>
        <br />
		Por su elevado contenido de vitaminas B5 y B6 nos ayuda a mantener un estado de ánimo estable, además de ser de gran ayuda con los dolores de cabeza y la fatiga. 
         <br /><br />
         <div class="sub">Cereales integrales</div>
        <br />
		Aumentan los niveles de serotonina, al estimular la secreción de insulina, hormona que aumenta la disposición de triptófano para formar serotonina, siendo de gran ayuda en tratamientos contra la ansiedad y la depresión.
          <br /><br />
          <div class="sub">Piña</div>
        <br />
		Al igual que el plátano, tiene un alto contenido de triptófano, además su alto contenido en vitaminas, minerales y compuestos que activan la serotonina, ayudan a generar mayor vitalidad, 
          <br /><br />
          <div class="sub"><a href="http://www.chenson.com.mx/blog/6%20Alimentos%20para%20activar%20tu%20cerebro.php">Chocolate</a></div>
        <br />
		No podía faltar el Chocolate como una deliciosa alternativa de mantener feliz a nuestro cerebro, pues favorece la producción de endorfinas sustancias del cerebro que te hacen sentirte bien, libera el estrés y activa el ánimo además de su propiedades antioxidantes, pero recuerda ingerirlo en cantidades pequeñas, por más difícil que parezca.
        <br /><br /> 
        <div class="sub">Chile</div>
        <br />
		El efecto del picante es bastante interesante, pues nuestro cerebro lo percibe como si fuera dolor, por lo que para contrarrestarlo libera endorfinas, sustancia natural conocida como hormona de la felicidad, pues ayuda a atenuar el dolor y aumentar la sensación de bienestar.
          <br /><br />
          <div class="sub">Almendras</div>
        <br />
		Su alto contenido  en magnesio la hace el alimento ideal para calmar los nervios, el consumo suficiente durante en día, permite dormir y descansar mejor
          <br /><br />
         <center>
         <div id="pietextos">
         <p>No olvides acompañar estos alimentos con una gran sonrisa, no importa que día sea o cual sea la situación, una actitud positiva siempre será el mejor remedio contra el mal humor y la tristeza :)</p>
         <br /><br /><br />
