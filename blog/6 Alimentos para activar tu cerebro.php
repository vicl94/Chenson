...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
     ...
     <title>6 Alimentos para activar tu cerebro</title>
    ...
    <meta property="og:title" content="6 Alimentos para activar tu cerebro|Mochilas Chenson"/>
    <meta property="og:image" content="http://www.chenson.com.mx/blog/imagenes/chocolates.png"/>
    <meta property="og:site_name" content="Francisco Salas"/>
    <meta property="og:description" content="Te presentamos un listado con seis productos bastante comunes y fáciles de 
        conseguir que tu cerebro agradecerá pues le permitirá optimizar sus funciones" />
...
<!--plug in facebook-->
  ...
  <br /><br /><br />    <br />       
        ...
        <div class= "titulos2">6 Alimentos </div>
				<div class="sub">Para activar tu cerebro</div>
                <center>
                <img src="imagenes/cerebro.png" align="center"/>
                </center>
                <br />
        <div id="textos">
        ...
        <br />
        Para sobrellevar el ir y venir que requiere la vida diaria, es de importante mantener 
        una sana alimentación, no solo para mejorar nuestro desempeño físico, sino también para 
        mantener un buen funcionamiento en nuestras habilidades cognitivas.
        <br />
        Para ello te presentamos un listado con seis productos bastante comunes y fáciles de 
        conseguir que tu cerebro agradecerá pues le permitirá optimizar sus funciones:
        
        <br />  <br />
		<div class="sub">Agua</div>
        <br />
		Nuestro cerebro, compuesto en su mayor parte por agua, necesita mantenerse hidratado permanentemente,
         por lo que se convierte en el elemento más importante de esta lista, pues definitivamente sin el liquido
          vital, la vida no sería posible.
          <br />  <br />
          <div class="sub">Plátano</div>
        <br />
		Este rico fruto interviene en la síntesis de la dopamina, un neurotransmisor que influye en la memoria y 
        el buen humor, por su contenido de vitaminas B6, acido fólico, C y minerales como calcio, fósforo, magnesio y potasio.
         <br /><br />
         <div class="sub">Semillas de calabaza</div>
        <br />
		Un puñado de estas semillas al día te abastecerá de el zinc que tu cuerpo necesita favoreciendo así diversas habilidades
         mentales como la memoria y la agilidad.
          <br /><br />
          <div class="sub">Nueces</div>
        <br />
		Con su respectiva moderación por su contenido calórico, este delicioso fruto seco, se vuelve un ingrediente importante para
         el funcionamiento del cerebro por su alto contenido de antioxidantes, fibras, vitaminas E, B1, B2, B3, B6, acido fólico,
          gran variedad de minerales, aparte de protegernos de distintas enfermedades del corazón, mejora nuestras capacidades de 
          aprendizaje y es de gran ayuda contra los trastornos de humor.
          <br /><br />
          <div class="sub">Chocolate</div>
        <br />
		Una deliciosa alternativa de mantener feliz a nuestro cerebro, pues favorece la producción de endorfinas sustancias del cerebro
         que te hacen sentirte bien, libera el estrés y activa el ánimo además de su propiedades antioxidantes, pero recuerda ingerirlo
          en cantidades pequeñas, por más difícil que parezca. 
          <br /><br />
          <div class="sub">Brócoli</div>
        <br />
		Este tan temido miembro de las legumbres, contiene proteínas, azúcares,  fibras, vitaminas A, C, E, K, acido fólico, B3 y B6 
        entre otras vitaminas y minerales, se convierte en un excelente antioxidante, y entre sus múltiples beneficios se convierte en 
        un excelente aliado para la memoria y al procesamiento de información de nuestro cerebro.
         <br /><br />
         Así que ya lo saben amigos, a disfrutar de estos ingredientes, pues no solo nos ayudara a tomar mejores decisiones, sino 
         que también contribuirán a hacernos más felices.
         <br /><br /><br />
         <center>
         <div id="pietextos">
         <p><h1>Recuerda que en Chenson, tenemos una amplia gama de<a href="../galerias/Loncheras.php" class="clase2" title="Da click para conocer productos">
         loncheras</a> para todas las edades, que harán más fácil el llevar tus alimentos a todos lados.</h1></p>
             <br /><br /><br />
       ...
       <br />
        ...
        <center>
                <div class="fb-comments" data-href="http://www.chenson.com.mx/blog/6 alimentos para activar tu cerebro.php" data-colorscheme="light" data-numposts="5" data-width="650" align="center"></div>
                </center>
