...
$(function () {
 ...
 <!--fixed-->
    ...
    <body>
        ...
        <?php 
		if($nro_pagina>1)
			echo"<a href='mochilas.php?num=".($nro_pagina-1)."' class='clase3' > Anterior </a>";
			
			for($i=1; $i<=$can_paginas;$i++){
				if ($i==$nro_pagina)
					echo $i."";
				else
					echo"<a href='mochilas.php?num=$i' class='clase2'>$i</a>";
				}
		if($nro_pagina<$can_paginas)		
			echo"<a href='mochilas.php?num=".($nro_pagina+1)."' class='clase3'> Siguiente </a>";		
		?>
        </div>
         <!--termina galeria-->
