 ...
 <!--fixed-->
    ...
    <body>
    	...
    	<header>
         ...
         <!--galeria-->
         <div class= "titulos2">mochila con ruedas</div>
        ...
        <?php 
		if($nro_pagina>1)
			echo"<a href='mochila_con_ruedas.php?num=".($nro_pagina-1)."'> Anterior</a>";
			
			for($i=1; $i<=$can_paginas;$i++){
				if ($i==$nro_pagina)
					echo $i."";
				else
					echo"<a href='mochila_con_ruedas.php?num=$i'>$i</a>";
				}
		if($nro_pagina<$can_paginas)		
			echo"<a href='mochila_con_ruedas.php?num=".($nro_pagina+1)."'>Siguiente</a>";		
		?>
        </div>
         <!--termina galeria-->
