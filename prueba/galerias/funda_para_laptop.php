...
if (is_numeric($nro_pagina))
	...
	$consulta=mysql_query("select * from tienda  where cuerpo= 'funda de neopreno' limit $inicio,$reg_por_pagina",$conexion);
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
     <title>Fundas para laptop</title>
 ...
 <!--fixed-->
    ...
    <body>
    	...
    	<header>
         ...
         <!--galeria-->
        <div class= "titulos2">Fundas para laptop</div>
		...
		<div class="contenedor">
			...
			<div class="caja">
				...
				<form method="post" action="../carrito/detalle.php" name="detalle">
				...
				<form action="../carrito/detalle.php" method="post" name="detalle">
        ...
        <?php 
		if($nro_pagina>1)
			echo"<a href='funda_para_laptop.php?num=".($nro_pagina-1)."'> Anterior</a>";
			
			for($i=1; $i<=$can_paginas;$i++){
				if ($i==$nro_pagina)
					echo $i."";
				else
					echo"<a href='funda_para_laptop.php?num=$i'>$i</a>";
				}
		if($nro_pagina<$can_paginas)		
			echo"<a href='funda_para_laptop.php?num=".($nro_pagina+1)."'>Siguiente</a>";		
		?>
        </div>
         <!--termina galeria-->
