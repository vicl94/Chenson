...
$consulta=mysql_query("select * from tienda where marca= '1818'", $conexion);
...
if (is_numeric($nro_pagina))
	...
	$consulta=mysql_query("select * from tienda  where marca= '1818' limit $inicio,$reg_por_pagina",$conexion);
    ...
    <body>
		...
		<br /><br /><br /><br />
			...
			<div class="caja">
				...
				<form action="../carrito/detalle2.php?id=<?php echo $id?>" method="post" name="detalle">
				<!--<input name="id" type="hidden" value="<?php //echo $id?>" />-->
				<input  type="submit" value="Detalle" onClick="../carrito/detalle.php?id='.$id.'">
				</form>
        ...
        <?php 
		if($nro_pagina>1)
			echo"<a href='1818.php?num=".($nro_pagina-1)."'> Anterior</a>";
			
			for($i=1; $i<=$can_paginas;$i++){
				if ($i==$nro_pagina)
					echo $i."";
				else
					echo"<a href='1818.php?num=$i'>$i</a>";
				}
		if($nro_pagina<$can_paginas)		
			echo"<a href='1818.php?num=".($nro_pagina+1)."'>Siguiente</a>";		
		?>
        </div>
         <!--termina galeria-->
