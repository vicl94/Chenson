...
<!--menu-->   
	...
	?>
        ...
        <div class= "titulos3">Bienvenidos al mundo</div>
               ...
               <div class="jimgMenu">
  <ul>
  	<li id="salud"><a href="blog/Categorias/Salud.php">Salud</a></li>
    <li id="cultura"><a href="blog/Categorias/Cultura y esparcimiento.php">Cultura y esparcimiento</a></li>
    <li id="educacion"><a href="blog/Categorias/Educacion.php">Educación</a></li>
    <li id="mexico"><a href="blog/Categorias/Conociendo Mexico.php">Conociendo México</a></li>
    <li id="tecnologia"><a href="blog/Categorias/Tecnologia.php">Tecnología</a></li>
  </ul>
</div>
<br  style="clear:both"/>
...
<hr style="width:100%;text-align:center;height:2px;border:1px;color:#e2e2e2;background-color:#e2e2e2;" />
	...
	while ($filas=mysql_fetch_array($consulta)){
			...
			?>
                ...
                <center>
                <img src="<?php echo $Imagen ; ?>"  width="160px" alt="<?php echo $Titulo ; ?>" />
                </center>
                   <br />              
                 
                <?php echo $Resumen ; ?>
                 <br />                
               <a href="<?php echo $Enlace; ?>" class="clasevm" title="Ver artículo completo"> <p align="center">Ver más</p></a>
                </div>
                <!--Post 1-->
                 <?php }?>
                <div class="archivos">
       ...
       <div id="accesor">
        	<a href="galerias/mochilas.php"><img src="img/pins/mochila.png" width="65" class="pins" title="Mochilas"/></a>
            ...
            <a href="galerias/maletas.php"><img src="img/pins/maletas.png" width="65" class="pins" title="Maletas"/></a>
            <a href="galerias/mochilas_de_camping.php"><img src="../img/pins/camping.png" width="57" class="pins" title="Mochilas de camping"/></a>
        </div>
        <div id="varios">	
        	<div id="destacado">
