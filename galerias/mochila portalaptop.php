...
$consulta=mysql_query("select * from tienda where cuerpo= 'mochila' and Plus= 'Portalaptop'", $conexion);
...
if (is_numeric($nro_pagina)){
	...
	$consulta=mysql_query("select * from tienda  where cuerpo= 'mochila' and Plus= 'Portalaptop' limit $inicio,$reg_por_pagina",$conexion);
...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<!--termina plugin facebook-->
		...
		<!--Regresar principal-->
         <div class="RegPcpl">
         	<form action="#" method="post" name="Filtrar"><input name="Portalaptop" type="radio" value="mochilas.php" checked="checked" /><a href="mochilas.php" class="clase4">Regresar a mochilas</a></form>
         </div>
         <!--Regresar principal-->
        ...
        <?php 
		if($nro_pagina>1)
			echo"<a href='mochila portalaptop.php?num=".($nro_pagina-1)."'> Anterior</a>";
			
			for($i=1; $i<=$can_paginas;$i++){
				if ($i==$nro_pagina)
					echo $i."";
				else
					echo"<a href='mochila portalaptop.php?num=$i'>$i</a>";
				}
		if($nro_pagina<$can_paginas)		
			echo"<a href='mochila portalaptop.php?num=".($nro_pagina+1)."'>Siguiente</a>";		
		?>
        </div>
         <!--termina galeria-->
