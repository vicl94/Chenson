...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  .horizontal-nav ul {
    ...
    text-align: center;
    border-radius: 6px;
    border: 1px solid #10335a;
  }
  .horizontal-nav ul li {
    float: left;
    border-left: 1px solid #184670;
  }
  ...
  <br /><br /><br />    <br />       
          ...
          <div class="panel clearfix" id="panel-1">
            <nav class="horizontal-nav clearfix">
              <ul>
                <li><a href="blog/Categorias/Salud.php">Salud</a></li>
                <li><a href="blog/Categorias/Educacion.php">Educación</a></li>
                <li><a href="blog/Categorias/Cultura y esparcimiento.php">Cultura y esparcimiento</a></li>
                <li><a href="blog/Categorias/Tecnologia.php">Tecnología</a></li>
                <li><a href="blog/Categorias/Conociendo Mexico.php">Conociendo México</a></li>
              </ul>
            </nav>
            <br>
          </div>
